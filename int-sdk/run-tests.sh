...
scripts/2_standalone-project-y1.sh workspaces/ws1 projects/prj1 http://127.0.0.1:8001 resources/project-Y1-emu.zip
scripts/3_dependent-project-y1.sh workspaces/ws1 projects/prj2 http://127.0.0.1:8001 resources/project-Y1-emu.zip
