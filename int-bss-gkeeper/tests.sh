...
#docker run -d --name son-bss -h sp.int3.sonata-nfv.eu -p 25001:1337 -p 25002:1338 -v /etc/ssl/private/sonata:/usr/local/yeoman/SonataBSS/app/certs/:ro --log-driver=gelf --log-opt gelf-address=udp://10.31.11.37:12900 registry.sonata-nfv.eu:5000/son-yo-gen-bss grunt serve:integration_tests --gkApiUrl=https://sp.int3.sonata-nfv.eu:32001 --suite=service_Instantiation --hostname=sp.int3.sonata-nfv.eu --debug
docker run -d --name son-bss -h sp.int3.sonata-nfv.eu -p 25001:1337 -p 25002:1338 --log-driver=gelf --log-opt gelf-address=udp://10.31.11.37:12900 registry.sonata-nfv.eu:5000/son-yo-gen-bss grunt serve:integration_tests --gkApiUrl=http://sp.int3.sonata-nfv.eu:32001/api/v2 --suite=service_Instantiation --hostname=sp.int3.sonata-nfv.eu --userManagementEnabled=false --protocol=http --debug
