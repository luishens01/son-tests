...
resp=$(curl -H 'Content-Type: application/json' -X GET -G http://sp.int3.sonata-nfv.eu:32001/api/v2/kpis?name=example_gauge&instance=gtkkpi&job=sonata&base_labels[label1]=value3&base_labels[label2]=value4)
