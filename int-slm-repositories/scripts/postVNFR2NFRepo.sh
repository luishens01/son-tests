...
resp=$(curl -qSfsw '\n%{http_code}' -H "Content-Type: application/json" -X POST -d @int-slm-repositories/resources/vnfr.json http://sp.int3.sonata-nfv.eu:4002/records/vnfr/vnf-instances)
echo $resp
