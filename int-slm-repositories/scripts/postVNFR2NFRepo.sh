...
resp=$(curl -qSfsw '\n%{http_code}' -H "Content-Type: application/json" -X POST -F @int-slm-repositories/resources/vnfr.json http://api.int.sonata-nfv.eu:4002/records/vnfr/vnf-instances)
echo $resp
